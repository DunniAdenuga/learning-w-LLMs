...
- difficulty per module: intro | core | apply | challenge.
  Judge this against the LEVEL OF THIS COURSE, not against programming in
  general, and vary it to reflect what the module actually demands:
    ...
    challenge = genuinely hard for a strong student at this level: open-ended,
                multi-step, or requiring judgement under ambiguity
  Use "challenge" sparingly — at most one or two modules in a topic, and only
  where the work really is harder than the course's normal standard.
